...
public class GladiatorGym {
    ...
    private void init() {
        ...
        employeeModifyWindow = new EmployeeModifyWindow();
        ...
        memberModifyWindow = new MemberModifyWindow();
        ...
        employeeModifyWindow.setCoordinator(coordinator);
        ...
        memberModifyWindow.setCoordinator(coordinator);
        ...
        coordinator.setEmployeeModifyWindow(employeeModifyWindow);
        ...
        coordinator.setMemberModifyWindow(memberModifyWindow);
